...
class ServiceEdit(unittest.TestCase):
    def setUp(self):
    ...
    def test_service_edit(self):
        ...
        driver.find_element_by_id("id_service_charge").click()
        # ERROR: Caught exception [ERROR: Unsupported command [doubleClick | id=id_service_charge | ]]
        driver.find_element_by_id("id_service_charge").clear()
        driver.find_element_by_id("id_service_charge").send_keys("600.00")
