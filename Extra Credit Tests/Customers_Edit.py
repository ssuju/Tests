...
class CustomersEdit(unittest.TestCase):
    def setUp(self):
    ...
    def test_customers_edit(self):
        ...
        driver.find_element_by_id("id_city").click()
        # ERROR: Caught exception [ERROR: Unsupported command [doubleClick | id=id_city | ]]
        ...
        driver.find_element_by_id("id_phone_number").send_keys("402-554-3000")
        driver.find_element_by_xpath(
            "(.//*[normalize-space(text()) and normalize-space(.)='*'])[10]/following::button[1]").click()
